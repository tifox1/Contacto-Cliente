...
class FormulariosAdmin(admin.ModelAdmin):
    list_display=("id_cliente", "salesman_name", "contact", "client_type", "closed_sells", "stop_selling", "order", "competition", "seller_name", "product_details", "sample", "comment", "datetime_sent")
